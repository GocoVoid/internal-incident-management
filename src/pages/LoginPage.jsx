...
const LoginPage = () => (
  <div className="min-h-screen flex">
    ...
    {/* ══ RIGHT PANEL — Dynamic form stages ══ */}
    <div className="flex-1 flex flex-col bg-gray-50">
      ...
      {/* Form area — LoginForm manages its own stage headings internally */}
      <div className="flex-1 flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-sm">
          {/* Stage-independent heading shown only for LOGIN stage is
              handled inside LoginStage component itself for clean separation */}
          <LoginForm />
        </div>
      </div>
