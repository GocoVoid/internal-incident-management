...
const SupportQueue = () => {
  ...
  /* keep selected ticket in sync with list after silentRefresh */
  useEffect(() => {
    if (!selected) return;
    ...
    <DashboardLayout title="My Queue">
      <div className="space-y-5 animate-fade-in">
        ...
        {loading ? <LoadingState /> : (
          <>
            {/* Stat Cards — identical layout to MyTicketsList */}
            ...
            {/* Filters + Table — identical structure to MyTicketsList */}
      ...
      {/* TicketDetailModal — role=SUPPORT_STAFF surfaces the Resolution Note tab */}
      <TicketDetailModal
        ticket={selected}
        isOpen={!!selected}
